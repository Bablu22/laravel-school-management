...
{
    public function MonthlySalaryView(): View
    {

        return view('admin.employees.monthly_salary_view');
    }
    ...
    public function MonthlySalaryPayslip(Request $request, $employee_id): Response
    {
        ...
        $pdf = PDF::loadView('admin.employees.monthly_salary_pdf', $data);
