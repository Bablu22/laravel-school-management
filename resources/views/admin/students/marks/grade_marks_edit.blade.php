        ...
        <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="btn-group float-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('student-registration.all')}}">Student
                                        list</a></li>
                                <li class="breadcrumb-item"><a href="{{route('marks.entry.grade')}}">Grade Marks</a>
                                </li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="" action="{{route('update.marks.grade',$editData->id)}}" method="POST"
                                  novalidate=""
                                ...
                                <div class="row">
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <input type="text" id="grade_name" value="{{$editData->grade_name}}"
                                               name="grade_name"
                                    ...
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <input type="text" class="form-control" value="{{$editData->grade_point}}"
                                    ...
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <input type="text" id="start_marks" value="{{$editData->start_marks}}"
                                ...
                                <div class="row mt-3">
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <input type="text" id="end_marks" value="{{$editData->end_marks}}"
                                               name="end_marks"
                                               class="form-control" required=""
                                    ...
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <input type="text" class="form-control" value="{{$editData->start_point}}"
                                    ...
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <input type="text" id="end_point" value="{{$editData->end_point}}"
                                ...
                                <div class="row mt-3">
                                    <div class="form-group mb-0 col-lg-4">
                                        ...
                                        <input type="text" id="remarks" value="{{$editData->remarks}}"
                                               name="remarks"
                                               class="form-control" required=""
