            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Student mark sheet management</h4>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="" action="{{route('report.marksheet.get')}}" method="GET" novalidate=""
                                  target="_blank">
                                @csrf
                                <div class="row mt-3">
                                    ...
                                    <div class="form-group mb-0 col-lg-3">
                                        <label for="id_no" class="mb-2 pb-1">Student ID</label>
                                        <select required id="id_no" name="id_no"
                                                class="select2 form-control mb-3 custom-select">
                                            <option disabled selected hidden>Select</option>
                                            @foreach($students as $student)
                                                <option
                                                    value="{{$student['student']['id_no']}}">{{$student['student']['id_no']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
